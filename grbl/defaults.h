...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef DEFAULTS_MAKEBLOCK_XY_PLOTTER_V1P5
  // Settings for hacked Makeblock XY Plotter v1 v2 hybrid.
  // Timing belt: 2.032mm spacing (25 per 2 inches).
  #define BELT_SPACING 2.032

  // X
  #define MICROSTEPS_X 8
  #define STEPS_PER_REV_X 200.0
  #define MM_PER_REV_X (BELT_SPACING * 18.0) /* 18T pulley */
  #define DEFAULT_X_STEPS_PER_MM (STEPS_PER_REV_X * MICROSTEPS_X / MM_PER_REV_X)

  // Y
  #define MICROSTEPS_Y 32
  #define STEPS_PER_REV_Y 200.0
  #define MM_PER_REV_Y (BELT_SPACING * 90.0) /* 18T pulley */
  #define DEFAULT_Y_STEPS_PER_MM (STEPS_PER_REV_Y * MICROSTEPS_Y / MM_PER_REV_Y)

  #define DEFAULT_Z_STEPS_PER_MM 250.0 /* no actual z axis */
  ...
  #define DEFAULT_Y_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 380.0 // (actual max 390) mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 310.0 // (actual max 320) mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL  10.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 1000.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK 0x02   // b00000zyx  +x, -y, +z
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25 // msec (0-254, 255 keeps steppers enabled)
  #define DEFAULT_STATUS_REPORT_MASK 1 // MPos enabled
  #define DEFAULT_JUNCTION_DEVIATION 0.01 // mm
  #define DEFAULT_ARC_TOLERANCE 0.002 // mm
  ...
  #define DEFAULT_HOMING_ENABLE 1  // false
  #define DEFAULT_HOMING_DIR_MASK 0x02 // b00000zyx  x, -y, z
  #define DEFAULT_HOMING_FEED_RATE 25.0 // mm/min
  #define DEFAULT_HOMING_SEEK_RATE 500.0 // mm/min
  #define DEFAULT_HOMING_DEBOUNCE_DELAY 250 // msec (0-65k)
  #define DEFAULT_HOMING_PULLOFF 1.0 // mm
