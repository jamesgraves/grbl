...
#define DEFAULTS_MAKEBLOCK_XY_PLOTTER_V1P5
#define CPU_MAP_MAKEBLOCK_ORION // Arduino Uno CPU
...
#define HOMING_CYCLE_0 (1<<X_AXIS)                // move X first
#define HOMING_CYCLE_1 (1<<Y_AXIS)                // move Y second
